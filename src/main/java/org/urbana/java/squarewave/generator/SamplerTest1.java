...
public class SamplerTest1 {
	...
	public static void main(String[] args){
		...
		for(Long i=0L;i<325;i++){
		
		BigDecimal time = new BigDecimal(generateRandom().toString()).multiply(new BigDecimal("1024")).multiply(new BigDecimal("3.14159265359"))
				 ;
		...
		String a0 = squareWave(new BigDecimal("51.2").add(new BigDecimal(k)),time);
		a= a+a0;
		}
